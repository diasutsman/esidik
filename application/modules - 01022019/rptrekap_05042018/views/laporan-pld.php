...
<center>
    ...
    <h2><?php echo $cominfo["address1"];?><br>
        Telepon: <?php echo $cominfo["phone"];?>, Faks: <?php echo $cominfo["fax"];?></h2>
<hr/>
<h1>
...
<table class="head" width="100%">
    <tr>
        ...
        <td style="border:0px" colspan="<?php echo ($jmlFieldAbs+$jmlFieldAtt+13)?>">: &nbsp;&nbsp;&nbsp;<?php echo $empinfo["dept"]?></td>
    </tr>
    <tr>
        <td width="" style="border:0px">Periode</td>
        <td style="border:0px" colspan="<?php echo ($jmlFieldAbs+$jmlFieldAtt+13)?>">: &nbsp;&nbsp;&nbsp;<?php echo format_date_ind($empinfo["datestart"])." s/d ".format_date_ind($empinfo["datestop"])?></td>
    </tr>
    <tr>
        <td width="" style="border:0px">Hari Libur Nasional</td>
        <td style="border:0px" colspan="<?php echo ($jmlFieldAbs+$jmlFieldAtt+13)?>">: &nbsp;&nbsp;&nbsp;<?php echo $empinfo["holidays"]?></td>
    </tr>
</table>
<br>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    ?>
    <tr border="1">
        <td class="text"><?php echo ($excelid==1?" ".$row["userid"]:$row["userid"]) ?></td class="text">
    ...
    <tr>
        <td width="100%" style="border: none" colspan="36">
            <table cellspacing="0" cellpadding="0" border="0">

                <!-- SPACER ROW -->
                <tr>
                    <td style="border: none" colspan="36">&nbsp;</td>
                </tr>

                <!-- TABLE KETERANGAN -->
                <tr>
                    <td valign="top" width="40%" style="border: none" colspan="7">
                    ...
                    <!--
                    <?php
                    for ($i=0; $i < ($jmlFieldAbs+$jmlFieldAtt); $i++) { ?>
                        <td valign="top" width="0%" style="border: none">
                            &nbsp;
                        </td>
                    ...
                    <!-- SPACER COL -->
                    <td valign="top" width="10%" style="border: none" colspan="5">
                        &nbsp;
                    </td>

                    <!-- TABLE TTD -->
                    <td valign="top" width="40%" style="border: none" colspan="24">
                        <table cellspacing="0" cellpadding="0" class="tblnoborder">
                            <tr>
                                <td colspan="24">
                                    ..............................,......................................................
                                </td>
