...
<script>
    ...
    function doSinkronData() {
        var cek = $(".selected:checked").length;
        var cMsg= "Anda yakin men-sikronisasi <b>semua data pegawai</b> dengan data SIMPEG ?<br>Waktu proses membutuhkan waktu cukup lama..<br>Catatan: Pastikan Kode Unit Kerja Sama antara aplikasi dengan SIMPEG";
        var cekData="All";
        if (cek > 0) {
            cekData = $('input[name=cek_del]:checked').map(function () {
                return $(this).val();
            }).get();
            cMsg="Anda yakin men-sikronisasi <b>data pegawai yang di pilih</b> dengan data SIMPEG ?<br>Waktu proses membutuhkan waktu cukup lama.. <br><b><em>Catatan: Pastikan Kode Unit Kerja Sama antara Aplikasi dengan SIMPEG</em></b>";
        }
