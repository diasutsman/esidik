                    ...
                    <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <input id="userid" name="userid" type="userid" placeholder="ID Pegawai" readonly value="<?php echo $field["nip"]?>" class="form-control col-md-12 col-xs-12">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="badgenumber">NIP</label>
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <input id="badgenumber" name="badgenumber"  readonly type="badgenumber" placeholder="NIP Pegawai" value="<?php echo $field["nip"]?>" class="form-control col-md-12 col-xs-12">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <?php echo form_dropdown("gender",$this->utils->getGender(),$field["gender"],"id='gender' class='form-control input-sm' ");?>
                            </div>
                            <div class="col-md-offset-6">
                                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="agama">Agama</label>
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    <?php echo form_dropdown("agama",$this->utils->getAgama(),$field["religion"],"id='agama' class='form-control input-sm'  ");?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <input id="placebirthdate" name="placebirthdate" type="text" placeholder="Tempat Lahir"  value="<?php echo $field["placebirthdate"]?>" class="form-control col-md-12 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group date">
                                    <input class="form-control" placeholder="Tanggal Lahir"  value="<?php echo ymdTodmy($field["birthdate"])?>"  type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <?php echo form_dropdown("stspeg",$this->utils->getStatusPegawai(),$field["jftstatus"],"id='stspeg' class='form-control input-sm'  ");?>
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group date">
                                    <input class="form-control" placeholder="TMT"  name="jftdate" type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <?php echo form_dropdown("jenisjabatan",$this->utils->getJenisJabatan(),$field["jenisjabatan"],"id='jenisjabatan' class='form-control input-sm' ");?>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="jenispegawai">Jenis Pegawai</label>
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <?php echo form_dropdown("jenispegawai",$this->utils->getJenisPegawai(),$field["jenispegawai"],"id='jenispegawai' class='form-control input-sm' ");?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <?php echo form_dropdown("kedudukan",$this->utils->getKedudukanPegawai(),$field["kedudukan"],"id='kedudukan' class='form-control input-sm' ");?>
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group">
                                     <div class="input-group date">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <?php echo form_dropdown("golru",$lstGol,$field["golru"],"id='golru' class='form-control input-sm' ");?>
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group date">
                                    <input class="form-control" placeholder="TMT"  name="tmtpangkat" value="<?php echo ymdTodmy($field["tmtpangkat"])?>"  type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-offset-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kelasjabatan">Kelas Jabatan</label>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <input class="form-control" placeholder="NPWP" name="npwp" value="<?php echo $field["npwp"]?>" type="text">
                            </div>
                            <div class="col-md-offset-6">
                                <?php
                                $cek1=""; $cek2="";
...
<script>
    ...
    function saveForm() {
        if (($("#txt1").val() != "")) {
            $.ajax({
                url: '<?php echo site_url('pegawai/savenew');?>', dataType: 'json', type: 'POST', data: $("#inputForm").serialize(), success: function (data) {
