    ...
    if ($byuser == 1) {
        ...
        if (($empinfo['isplt'] == 1)) {
            ...
            <tr>
                ...
                <td style="border:0px" class="text">: <?php echo $empinfo['kelasjabatan'] == 0 ? '' : $empinfo['kelasjabatan']; ?></td>
            ...
            <tr>
                ...
                <td style="border:0px"></td>
                <td width="150" style="border:0px" class="text">Kelas Jabatan</td>
                <td style="border:0px" class="text">: <?php echo $empinfo['plt_kelasjabatan'] == 0 ? '' : $empinfo['plt_kelasjabatan']; ?></td>
                <td style="border:0px">&nbsp;</td>
            </tr>
            <?php
        ...
        if ($empinfo['isplt'] == 1) {
            ...
            if ($empinfo['kriteriaPlt'] == 1 || $empinfo['kriteriaPlt'] == 2) {
                ...
                <tr>
                    ...
                    <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format(ceil(round($empinfo['tunjangan'], 2)), 0, ',', '.') : $excelid == 1 ? ceil(round($empinfo['tunjangan'])) : number_format(ceil(round($empinfo['tunjangan'], 2)), 0, ',', '.') ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                ...
                <tr style="border-bottom:2px solid">
                    ...
                    <td style="border:0px" class="text"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format($pengurangan, 0, ',', '.'): $excelid == 1 ? ceil(round($pengurangan, 2)) : number_format($pengurangan, 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format($totltunk, 0, ',', '.'): $excelid == 1 ? $totltunk : number_format($totltunk, 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td style="border:0px" class="text"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format(ceil(round($empinfo['tunjanganplt'], 2)), 0, ',', '.'): $excelid == 1 ? (ceil(round($empinfo['tunjanganplt'], 2))) : number_format(ceil(round($empinfo['tunjanganplt'], 2)), 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr style="border-bottom:2px solid">
                    ...
                    <td style="border:0px" class="text"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format($penguranganplt, 0, ',', '.'): $excelid == 1 ? ceil(round($penguranganplt, 2)) : number_format($penguranganplt, 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr style="border-bottom:2px solid">
                    ...
                    <td style="border:0px" class="text"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format($totltunkplt, 0, ',', '.'): $excelid == 1 ? $totltunkplt : number_format($totltunkplt, 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td style="border:0px" class="text"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format(ceil(round($grandttl, 2)), 0, ',', '.'): $excelid == 1 ? (ceil(round($grandttl, 2))) : number_format(ceil(round($grandttl, 2)), 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <?php
                ...
                <tr>
                    ...
                    <td style="border:0px" class="text"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format(ceil(round($tunjangan, 2)), 0, ',', '.'):$excelid == 1 ? ceil(round($tunjangan)) : number_format(ceil(round($tunjangan, 2)), 0, ',', '.') ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border:0px" class="text"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format($totltunk, 0, ',', '.'): $excelid == 1 ? $totltunk : number_format($totltunk, 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <?php
            ...
            ?>
            <tr>
                <td width="150" style="border:0px" class="text"><b>Tunjangan Kinerja <?php echo ($empinfo['kriteriaPlt'] == 3) ? "PLT/PLH" : "" ?></b></td>
                <td style="border:0px" class="text"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format(ceil(round($empinfo['tunjangan'], 2)), 0, ',', '.'):$excelid == 1 ? ceil(round($empinfo['tunjangan'])) : number_format(ceil(round($empinfo['tunjangan'], 2)), 0, ',', '.') ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            ...
            <tr style="border-bottom:2px solid">
                <td width="150" style="border:0px" class="text"><b>Total Pengurangan</b></td>
                <td style="border:0px" class="text"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format($pengurangan, 0, ',', '.'): $excelid == 1 ? $pengurangan : number_format($pengurangan, 0, ',', '.'); ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            </tr>
            <tr>
        ...
        <?php } else {
            ...
            <tr>
                <td width="150" style="border:0px" class="text">ID</td>
                <td style="border:0px"  class="text" class="text">: <?php echo $empinfo['userid']; ?></td>
                <td width="150" style="border:0px" class="text"><?php echo "Unit Kerja ". ($empinfo['kriteriaPlt'] == 3 ? "PLT/PLH" : ""); ?></td>
            ...
            <tr>
                <td width="150" style="border:0px" class="text">NIP</td>
                <td style="border:0px" class="text" class="text">: <?php echo $empinfo['empID']; ?></td>
                <td width="150" style="border:0px" class="text"><?php echo "Jabatan " . ($empinfo['kriteriaPlt'] == 3 ? "PLT/PLH" : "") ?></td>
                <td style="border:0px">: <?php
            ...
            <tr>
                <td width="150" style="border:0px" class="text">Nama</td>
                <td style="border:0px" class="text">: <?php echo $empinfo['empName']; ?></td>
                <td width="150" style="border:0px" class="text">Kelas Jabatan <?php echo($empinfo['kriteriaPlt'] == 3 ? "PLT/PLH" : "") ?></td>
                <td style="border:0px">:
                    <?php
            ...
            <tr>
                <td width="150" style="border:0px" class="text"><b>Tunjangan Kinerja <?php echo ($empinfo['kriteriaPlt'] == 3) ? "PLT/PLH" : "" ?></b></td>
                <td style="border:0px" class="text"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format(ceil(round($tunjangan, 2)), 2, ',', '.'): $excelid == 1 ? ceil(round($tunjangan,2)) : number_format(ceil(round($tunjangan, 2)), 2, ',', '.') ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            </tr>
            ...
            <tr style="border-bottom:2px solid">
                <td width="150" style="border:0px" class="text"><b>Total Pengurangan</b></td>
                <td style="border:0px" class="text"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format($pengurangan, 2, ',', '.'): $excelid == 1 ? $pengurangan : number_format($pengurangan, 2, ',', '.'); ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            </tr>
            <tr>
                <td width="150" style="border:0px" class="text"><b>Total Tunjangan Kinerja</b></td>
                <td style="border:0px" class="text"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right" class="num"><b><?php echo $showpdf==1 ? number_format($totltunk, 2, ',', '.'): $excelid == 1 ? $totltunk : number_format($totltunk, 2, ',', '.'); ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            </tr>
        <?php } ?>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                ...
                foreach ($data as $row) {
                    ...
                    <tr >
                        ...
                        <td align="center"  class="text"><?php echo $showpdf==1 ? number_format($row['pengurangan'], 2, ',', '.'): $excelid == 1 ? $row['pengurangan'] : number_format($row['pengurangan'], 2, ',', '.'); ?></td>
                        <?php
                        $nPlt = 0;
                        $nUnkir = 0;
                        $nTotalRow = 0;
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                ...
                foreach ($data as $row) {
                    ...
                    <tr >
                        ...
                        <td align="right" class="num"><?php echo $showpdf==1 ? number_format(ceil(round($row['total'], 2)), 2, ',', '.') : $excelid == 1 ? ceil(round($row['total'], 2)) : number_format(ceil(round($row['total'], 2)), 2, ',', '.'); ?></td>
                    </tr>
                    <?php
                }
                ?>
