                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <select class="input-sm form-control" id="jnslap">
                                        ...
                                        <option value="2">Rekapitulasi Ketidakhadiran</option>
                                        <option value="3">Rekapitulasi Kehadiran (Full Tanggal)</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
...
$(function(){
	...
	$('#btnexcel').click(function(){
		...
		$('<form action="<?php echo site_url('rptrekap/view');?>" method="POST" target="_blank" style="display:none">' +
            ...
            '<input type="hidden" name="jnslap" value="'+par11+'" />'+
