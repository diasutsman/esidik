			...
			<div class="row form-horizontal">
				...
				<div class="form-group">
					<div class="col-md-2 col-md-offset-2">
						<button type="button" id="btncaridata" class="btn btn-sm btn-primary"> Display</button> <button type="button" id="btnproses" class="btn btn-sm btn-success"><i class="fa fa-dashboard"></i> Proses data</button>
					</div>
				</div>
			</div>
		</div>
...
$(function(){
	...
	$('#btncaridata').click(function(){
		load_url('<?php echo site_url('regen/pagging/0') ?>',"#list-data");
	});
	...
	$('#btnproses').click(function(){
        ...
        bootbox.confirm("Anda yakin memproses data?", function(result) {
            if(result) {

                $.ajax({
                    dataType: 'json',
                    type    : 'POST',
                    url: '<?php echo site_url('regen/pegawai') ?>',
                    data:{"org":par6,"stspeg":par7,"startdate":par8,"enddate":par9,"uid":cek_del},
