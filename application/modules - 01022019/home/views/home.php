                    ...
                    <div class="row">
                        ...
                        <!--<div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <h1 class="no-margins"><?php /*echo $jmlSakit>0? number_format($jmlSakit,0,",",".")." Pegawai": "-";*/?></h1>
                                </div>
                            </div>
                        </div>-->
                        <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $jmlAlpha>0? number_format($jmlAlpha,0,",",".")." Pegawai": "-";?></h1>
                            </div>
                        </div>
                    </div>
                    </div>
