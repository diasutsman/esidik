...
$url_pag =  site_url("jadwalkrjkhusus/pagging/0");
                    ...
                    foreach ($result as $key =>$value)
                    {
                        ...
                        <tr>
                            ...
                            while (strtotime($str2) <= strtotime($end2)) {
                                ...
                                {
                                    //print_r($value[strtotime($str2)]);
                                    $shiftId = explode("|", $value[strtotime($str2)]);
                                    $jmlShif=0;

                                    if (isset($shiftId[0])) {
                                        $lrec = $shiftId[0];
                                        $ket = explode("#", $shiftId[0]);
                                        ...
                                        echo "<td style='background-color:$col' class='rows text-center $cls' id='" . $userid . '-' . $str2 . "-01' data-fid='$str2' data-id='$userid' data-tgl='$lbltgl' data-rec='" . $lrec . "'  data-shift='1'>" . $lket . "</td>";
                                        $jmlShif++;
                                    }

                                    if (isset($shiftId[1])) {
                                        $lrec2 = $shiftId[1];
                                        $ket2 = explode("#", $shiftId[1]);
                                        ...
                                        $jmlShif++;
                                        echo "<td style='background-color:$col' class='rows text-center $cls' id='" . $userid . '-' . $str2 . "-02' data-fid='$str2' data-id='$userid' data-tgl='$lbltgl' data-rec='" . $lrec2 . "' data-shift='2'>" . $lket2 . "</td>";
                                    }
                                    if (isset($shiftId[2])) {
                                        $lrec3 = $shiftId[2];
                                        $ket3 = explode("#", $shiftId[2]);
                                        ...
                                        echo "<td style='background-color:$col' class='rows text-center $cls' id='" . $userid . '-' . $str2 . "-03' data-fid='$str2' data-id='$userid' data-tgl='$lbltgl' data-rec='" . $lrec3 . "' data-shift='3'>" . $lket3 . "</td>";
                                    }

                                    if ($jmlShif==0) {

                                        echo "<td style='background-color:$col' class='rows text-center $cls' id='" . $userid . '-' . $str2 . "-00' data-fid='$str2' data-id='$userid' data-tgl='$lbltgl' data-rec='" . $lrec . "' data-shift='0'>-</td>";
                                    }

                                } else
                                {
                                    echo "<td style='background-color:$col' class='rows text-center $cls' id='".$userid.'-'.$str2."-00' data-fid='$str2' data-id='$userid' data-tgl='$lbltgl' data-rec='".$lrec ."' data-shift='3'>" .$lket."</td>";
                                }
                                echo "</tr></table></td>";
...
<div id="context-menu" style="display:none">
    <ul class="dropdown-menu">
        <li><a href="#" onclick="showPil1()">Kehadiran</a>
        </li>
        <li><a href="#"  onclick="showPil2()">Ketidakhadiran</a>
        </li>
        <li><a href="#"  onclick="showPil3()">Hapus Status</a>
        </li>
    </ul>
</div>
<script>
    ...
    $(function(){
        ...
        $(".rows").click(function (){
            ...
            $.ajax({
                method:"post",
                url: "<?php echo site_url("jadwalkrjkhusus/gethistory")?>",
        ...
        /*$('.editrow').click(function(){
            ...
            $.getJSON('echo site_url('jadwalkrjkhusus/edit')'+xno,function() {})
