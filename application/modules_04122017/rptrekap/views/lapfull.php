...
<?php
	...
	$headcol .= '<th width="30" class="HDR">HDR</th>
				...
				<th width="30" class="DSL">DSL</th>
				<th width="30" class="PDK">DKL</th>
	...
	$tampilanReport .= '<tr align="center"><td colspan="'.(count($arr_days)+13).'" align="left" ><h4> Unit Kerja: '.$nama_dept.'</h4></td></tr>';
	...
	{				
		...
		for($i=0;$i<count($arr_days);$i++){		
			if(isset($datarekap[$dataatt->userid][$arr_days[$i]])) {
				...
				$tampilanReport .= '<td align="center" class="ALP">ALP</td>';
				$A++;
			}
		}
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="50" align="center" class="DSL">DSL</td>
