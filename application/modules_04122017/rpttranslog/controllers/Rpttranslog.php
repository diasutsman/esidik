...
class Rpttranslog extends MX_Controller {

    private $aAkses;
	function Rpttranslog(){
		parent::__construct();
        ...
        $this->aAkses = akses("Rpttranslog", $this->session->userdata('s_access'));
    ...
    public function pagging($page=0)
    {
        ...
        $query = $this->pegawai->getDaftar(1,10,$offset,null,$SQLcari);
        $jum_data = $this->pegawai->getDaftar(0,null,null,null,$SQLcari);
        $this_url = site_url('rpttranslog/pagging/');
