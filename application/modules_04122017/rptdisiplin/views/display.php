	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content">
			<div class="row form-horizontal">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-3 col-xs-12" for="jnspal">Jenis Laporan</label>
                    <div class="col-sm-2">
...
$(function(){
	...
	$('#btncaridata').click(function(){
		load_url('<?php echo site_url('rptdisiplin/pagging/0') ?>',"#list-data");
	});
	...
	$('#btnexcel').click(function(){
		...
		$('<form action="<?php echo site_url('rptdisiplin/view');?>" method="POST" target="_blank" style="display:none">' +
            ...
            '<input type="hidden" name="jns" value="'+par10+'" />'+
