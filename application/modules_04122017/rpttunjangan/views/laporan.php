...
<style> .num {
    ...
    <table class="head" width="100%">
        ...
        <tr>
            <td align="center"  style="border:0px">Telepon: <?php echo $cominfo['phone']; ?>, Fax: <?php echo $cominfo['fax']; ?></td>
        </tr>
    </table>
    <hr/>
    ...
    if ($byuser == 1) {
        ...
        if (($empinfo['isplt'] == 1)) {
            ...
            <tr>
                ...
                <td style="border:0px"></td>
                <td width="150" style="border:0px">Unit Kerja PLT/PLH&nbsp;</td>
        ...
        if ($empinfo['isplt'] == 1) {
            ...
            if ($empinfo['kriteriaPlt'] == 1 || $empinfo['kriteriaPlt'] == 2) {
                ...
                <tr>
                    ...
                    <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format(ceil(round($empinfo['tunjangan'], 2)), 0, ',', '.') : $excelid == 1 ? ceil(round($empinfo['tunjangan'])) : number_format(ceil(round($empinfo['tunjangan'], 2)), 0, ',', '.') ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                ...
                <tr style="border-bottom:2px solid">
                    ...
                    <td style="border:0px"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format($pengurangan, 0, ',', '.'): $excelid == 1 ? ceil(round($pengurangan, 2)) : number_format($pengurangan, 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="border:0px"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format(ceil(round($empinfo['tunjanganplt'], 2)), 0, ',', '.'): $excelid == 1 ? (ceil(round($empinfo['tunjanganplt'], 2))) : number_format(ceil(round($empinfo['tunjanganplt'], 2)), 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr style="border-bottom:2px solid">
                    ...
                    <td style="border:0px"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format($penguranganplt, 0, ',', '.'): $excelid == 1 ? ceil(round($penguranganplt, 2)) : number_format($penguranganplt, 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr style="border-bottom:2px solid">
                    ...
                    <td style="border:0px"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format($totltunkplt, 0, ',', '.'): $excelid == 1 ? $totltunkplt : number_format($totltunkplt, 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td style="border:0px"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format(ceil(round($grandttl, 2)), 0, ',', '.'): $excelid == 1 ? (ceil(round($grandttl, 2))) : number_format(ceil(round($grandttl, 2)), 0, ',', '.'); ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
                <?php
                ...
                <tr>
                    ...
                    <td style="border:0px"><b>: Rp. </b></td>
                    <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format(ceil(round($tunjangan, 2)), 0, ',', '.'):$excelid == 1 ? ceil(round($tunjangan)) : number_format(ceil(round($tunjangan, 2)), 0, ',', '.') ?></b></td>
                    <td style="border:0px">&nbsp;</td>
                    <td style="border:0px">&nbsp;</td>
                </tr>
            ...
            <tr style="border-bottom:2px solid">
                <td width="150" style="border:0px"><b>Total Pengurangan</b></td>
                <td style="border:0px"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format($pengurangan, 0, ',', '.'): $excelid == 1 ? $pengurangan : number_format($pengurangan, 0, ',', '.'); ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            </tr>
            <tr>
        ...
        <?php } else {
            ...
            <tr>
                <td width="150" style="border:0px">ID</td>
                <td style="border:0px"  class="text">: <?php echo $empinfo['userid']; ?></td>
                <td width="150" style="border:0px"><?php echo "Unit Kerja ". ($empinfo['kriteriaPlt'] == 3 ? "PLT/PLH" : ""); ?></td>
            ...
            <tr>
                <td width="150" style="border:0px"><b>Tunjangan Kinerja <?php echo ($empinfo['kriteriaPlt'] == 3) ? "PLT/PLH" : "" ?></b></td>
                <td style="border:0px"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format(ceil(round($tunjangan, 2)), 2, ',', '.'): $excelid == 1 ? ceil(round($tunjangan,2)) : number_format(ceil(round($tunjangan, 2)), 2, ',', '.') ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            </tr>
            ...
            <tr style="border-bottom:2px solid">
                <td width="150" style="border:0px"><b>Total Pengurangan</b></td>
                <td style="border:0px"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format($pengurangan, 2, ',', '.'): $excelid == 1 ? $pengurangan : number_format($pengurangan, 2, ',', '.'); ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            </tr>
            <tr>
                <td width="150" style="border:0px"><b>Total Tunjangan Kinerja</b></td>
                <td style="border:0px"><b>: Rp. </b></td>
                <td width="150" style="border:0px" align="right"><b><?php echo $showpdf==1 ? number_format($totltunk, 2, ',', '.'): $excelid == 1 ? $totltunk : number_format($totltunk, 2, ',', '.'); ?></b></td>
                <td style="border:0px">&nbsp;</td>
                <td style="border:0px">&nbsp;</td>
            </tr>
        <?php } ?>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                ...
                foreach ($data as $row) {
                    ...
                    <tr >
                        ...
                        <td align="center"><?php echo $showpdf==1 ? number_format($row['pengurangan'], 2, ',', '.'): $excelid == 1 ? $row['pengurangan'] : number_format($row['pengurangan'], 2, ',', '.'); ?></td>
                        <?php
                        $nPlt = 0;
                        $nUnkir = 0;
                        $nTotalRow = 0;
