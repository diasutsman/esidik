            ...
            <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <?php echo form_dropdown("idkat",$this->utils->getKategoriPresensi(0),"","id='idkat' class='form-control input-sm'");?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txt3">Potongan</label>
                    <div class="col-md-3 col-sm-3 col-xs-12">
...
<script>
    ...
    {
        load_url('<?php echo site_url('statabsen/pagging/0') ?>',"<?php echo (isset($order)?$order:'id')?>","<?php echo (isset($typeorder)?$typeorder:'sorting')?>");
    }
    ...
    function saveForm()
    {
        ...
        {
            $.ajax({
                url     : '<?php echo site_url('statabsen/save');?>',
                dataType: 'json',
                type    : 'POST',
