...
<script src="<?php echo base_url()?>assets/js/plugins/daterangepicker/daterangepicker.js"></script>
    <p class="alert alert-info"><span class="text-danger text-uppercase font-bold">Perhatian!!!</span> Tidak memasukan jadwal kerja normal (hanya 1 per hari ) di bagian ini</p>
