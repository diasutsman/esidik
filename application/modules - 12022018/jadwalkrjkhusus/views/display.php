...
<input type="hidden" id="noshift" value="">
...
<script>
	...
	$(function(){
		...
		$('#btncari').click(function(){
			...
			$.ajax({
				method:"post",
				url: "<?php echo site_url('jadwalkrjkhusus/buatjadwal') ?>",
	...
	function saveForm() {
        ...
        $("#shiftid").val($('#noshift').val());

		$.ajax({
			url: '<?php echo site_url('jadwalkrjkhusus/statusdata');?>/'+pildata,
    ...
    function showPil1()
    {
        ...
        var url ="<?php echo site_url('jadwalkrjkhusus/form1')?>/"+$('#tglpil').val()+"/"+$('#tglpil2').val()+"/"+$('#noshift').val();
    ...
    function showPil2()
    {
        ...
        var url ="<?php echo site_url('jadwalkrjkhusus/form2')?>/"+$('#tglpil').val()+"/"+$('#tglpil2').val()+"/"+$('#noshift').val();
        $("#input_data").html('<div style="position:absolute;left:0;right:0;top:50%;"><center></center></div>').load(url);
        showPopup('#popup');
    }
    ...
    function showPil3()
    {
        ...
        var url ="<?php echo site_url('jadwalkrjkhusus/form3')?>/"+$('#tglpil').val()+"/"+$('#tglpil2').val()+"/"+$('#noshift').val();
        $("#input_data").html('<div style="position:absolute;left:0;right:0;top:50%;"><center></center></div>').load(url);
        showPopup('#popup');
    }
