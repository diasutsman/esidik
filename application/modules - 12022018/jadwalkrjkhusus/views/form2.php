...
<p class="alert alert-info"><span class="text-danger text-uppercase font-bold">Perhatian..!!</span> Data akan dihapus..</p>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input class="form-control" name="catatan"  id="catatan" type="text" id="cek4" required>
    </div>
</div>
