...
<div class="table-responsive">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <th onClick="load_url('<?php echo $url_pag?>','ign_to','<?php echo (isset($order)?(($order=='ign_to')?$sorting:'sorting'):'sorting')?>')" ><div class="<?php echo (isset($order)?(($order=='ign_to')?$typeorder:'sorting'):'sorting')?>">Tidak Menghitung</div></th>
            <th></th>
        </tr>
        </thead>
        <tbody>
        ...
        foreach($result as $row)
        {
            ...
            <tr id="rowdata-<?php echo $row->id?>">
                ...
                <td><?php echo ($row->ign_to==0?"Jam Masuk & Keluar": ($row->ign_to==1? "Jam Masuk" : "Jam Keluar")) ?></td>
    ...
    $(function(){
        ...
        $('.editrow').click(function(){
            ...
            .done(function(response) {
                ...
                $('input[name="ign_to"][value="' + response['ign_to'] + '"]').prop('checked', true);
