...
<table class="head">
	...
	<?php } ?>
    <tr>
      <td <?php echo $clss; ?> style="border:0px">Telp: <?php echo $cominfo['phone']; ?>, Fax: <?php echo $cominfo['fax']; ?></td>
	  <td width="10" rowspan="4" style="border:0px">&nbsp;</td>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr class="<?php if($x % 2 === 0) echo 'even'; else echo 'odd'; ?>">
    ...
    <td align="right"><?php echo $excelid==1?ceil(round($row['tunjangan'],2)):number_format(ceil(round($row['tunjangan'],2)),0,'.',','); ?></td>
    <td align="right"><?php echo $excelid==1?ceil(round($row['totaltunjangan'],2)):number_format(ceil(round($row['totaltunjangan'],2)),0,'.',','); ?></td>
    <td align="right"><?php echo $excelid==1?(ceil(round($row['tunjangan'],2)) - ceil(round($row['totaltunjangan'],2))):number_format(ceil(round($row['tunjangan'],2)) - ceil(round($row['totaltunjangan'],2)),0,'.',','); ?></td>
  </tr>
 <?php 
  ...
  <tr>
    ...
    <td align="right"><b><?php echo $excelid==1?$totaltun:number_format($totaltun,0,'.',','); ?></b></td>
    <td align="right"><b><?php echo $excelid==1?$tottotaltun:number_format($tottotaltun,0,'.',','); ?></b></td>
    <td align="right"><b><?php echo $excelid==1?$totaltun - $tottotaltun:number_format($totaltun - $tottotaltun,0,'.',','); ?></b></td>
  </tr>
</table>
<br><br>
