        ...
        <div class="ibox-content gray-bg">
            <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txt1">Golongan</label>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <?php echo form_dropdown("txt1",$this->utils->getRefGolongan(),"","id='txt1' class='form-control input-sm' ");?>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txt2">Tarif</label>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <input id="txt2" name="txt2" type="text" placeholder="Uang Makan" class="form-control col-md-5 col-xs-12">
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txt3">Pajak</label>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <input id="txt3" name="txt3" type="text" placeholder="Pajak" class="form-control col-md-5 col-xs-12">
                    </div>
                </div>
...
<script>
    ...
    function saveForm()
    {
        ...
        {
            $.ajax({
                url     : '<?php echo site_url('setuangmakan/save');?>',
                dataType: 'json',
                type    : 'POST',
