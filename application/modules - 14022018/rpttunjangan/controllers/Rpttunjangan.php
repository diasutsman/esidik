...
//echo date("Y-m-d",strtotime($que->date_shift))." - ".$krglate." - ".$krgearly."<br>";
                ...
                if(isset($atar[$que->attendance])) {
					...
					*/
					...
					//echo $check_in.":".$check_out." - ".$krgstatus." - ".$akrga[$que->attendance]." - ".$atar[$que->attendance]." -> ".date('d-m-Y', strtotime($que->date_shift))." - ".$krglate." - ".$krgearly."<br>";
