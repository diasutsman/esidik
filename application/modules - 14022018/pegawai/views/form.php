                ...
                <div class="ibox-content gray-bg">
                    <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group">
                                    <input class="form-control" placeholder="TMT" name="tmtkedudukan" type="text" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <?php echo form_dropdown("eselon",$lstEselon,$field["eselon"],"id='eselon' class='form-control input-sm' disabled='disabled'");?>
                            </div>
                            <div class="col-md-offset-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="plt_kelasjabatan">Kelas Jabatan</label>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <?php echo form_dropdown("kelasjabatan",$lstKelas,$field["kelasjabatan"],"id='kelasjabatan' class='form-control input-sm' disabled='disabled'");?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group date">
                                    <input class="form-control" placeholder="TMT" name="tmtprofesi" type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <div class="input-group">
                                    <div class="unker2 input-group">
                                        <input type="text" class="input-sm form-control" readonly name="cari_unker2" id="cari_unker2" value="<?php echo $field["plt_deptname"]?>" placeholder="Unit Kerja ...">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group date">
                                    <input class="form-control" placeholder="TMT" name="tmt_plt" value="<?php echo ymdTodmy($field["tmt_plt"])?>"  readonly type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <?php echo form_dropdown("plt_eselon",$lstEselon,$field["plt_eselon"],"id='plt_eselon' class='form-control input-sm'  disabled='disabled'");?>
                            </div>
                            <div class="col-md-offset-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="plt_kelasjabatan">Kelas Jabatan</label>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <?php echo form_dropdown("plt_kelasjabatan",$lstKelas,$field["plt_kelasjabatan"],"id='plt_kelasjabatan' class='form-control input-sm'  disabled='disabled'");?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <input id="plt_sk" name="plt_sk" type="text"  placeholder="SK PLT/PLH" value="<?php echo $field["plt_sk"]?>" readonly class="form-control col-md-12 col-xs-12">
                            </div>
                            <div class="col-md-offset-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="plt_kelasjabatan">Jabatan</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input id="plt_jbtn" name="plt_jbtn" type="text"  placeholder="Jabatan" value="<?php echo $field["plt_jbtn"]?>" readonly class="form-control col-md-12 col-xs-12">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <input class="form-control" placeholder="NPWP" name="npwp" value="<?php echo $field["npwp"]?>" type="text" readonly>
                            </div>
                            <div class="col-md-offset-6">
                                <?php
                                $cek1=""; $cek2="";
