		...
		<div class="ibox-content">
			<div class="row form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" placeholder="Pencarian" class="input-sm form-control">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7 form-inline" id="data_5">
						<div class="input-daterange input-group" id="datepicker">
							<input type="text" class="input-sm form-control" name="start" id="start" value="<?php echo date("Y-m-01")?>"/>
							<span class="input-group-addon">s/d</span>
							<input type="text" class="input-sm form-control" name="end" id="end" value="<?php echo date("Y-m-t", strtotime(date("Y-m-d")))?>" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-2 col-md-offset-2">
						<button type="button" id="btncaridata" class="btn btn-sm btn-primary"> Display</button> <button type="button" id="btnproses" class="btn btn-sm btn-danger"> Proses data</button>
					</div>
				</div>
			</div>
		</div>
...
$(function(){
	...
	$('#btncaridata').click(function(){
		load_url('<?php echo site_url('rpttranslog/pagging/0') ?>',"#list-data");
	});
	...
	$('#btnproses').click(function(){
		...
		$.ajax({
			url     : '<?php echo site_url('rpttranslog/save');?>',
			dataType: 'json',
			type    : 'POST',
			data    : {"lmt":par4,"cari":par5,"org":par6,"stspeg":par7,"uid" : cek_del,"start" : par8,"end" : par9},
