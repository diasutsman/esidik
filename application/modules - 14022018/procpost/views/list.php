...
$url_pag =  site_url("procpost/pagging/0");
    ...
    <div class="dataTables_wrapper dt-bootstrap">
        <table class="table table-striped  table-bordered">
            ...
            <tr>
                ...
                <th onClick="load_url('<?php echo $url_pag?>','lastcreate','<?php echo (isset($order)?(($order=='lastcreate')?$sorting:'sorting'):'sorting')?>')"><div class="<?php echo (isset($order)?(($order=='lastcreate')?$typeorder:'sorting'):'sorting')?>">Log Terakhir</div></th>
            </tr>
            </thead>
            <tbody>
            <?php
