...
<?php
	...
	foreach($querycok->result() as $que) {
		if($que->late > 0 && $que->attendance !='AT_AT1' && $que->attendance !='AT_AT3' && $que->attendance !='AT_AT4' && $que->attendance !='AT_AT6' && $que->attendance !='AT_DK' && $que->attendance != 'NWK' && $que->workinholiday != 1 && strpos($que->attendance, 'AB_')===false) 
			...
			} else if($que->attendance == 'ALP' || $que->attendance == 'AB_12' ) {
			...
			} else if($que->attendance == 'AB_3' || $que->attendance == 'AB_4' || $que->attendance == 'AB_5' || $que->attendance == 'AB_6' || $que->attendance == 'AB_7' || $que->attendance == 'AB_8' || $que->attendance == 'AB_9' || $que->attendance == 'AB_14' || $que->attendance == 'AB_17' || $que->attendance == 'AB_20') {
	...
	*/
$RowReport = '
							<td align="center">'.($jC+$jS).'</th>
							<td align="center">'.$jDL.'</th>
							<td align="center">'.$jTB.'</th>
							<td align="center">'.$jA.'</th>
							<td align="center">'.$jTD.'</th>
							<td align="center">'.$jPC.'</th>
							<td align="center"></th>
							</tr>';
