                ...
                <div class="col-sm-5 m-b-xs">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="#" id="btn2" onClick="showMoveArea();">Area Mesin</a>
                            </li>
                            <li><a href="#" id="btn2" onClick="showUnit();">Unit Kerja</a>
                            </li>
                            ...
                            <li><a href="#" id="btn3" onclick="doTransUsb()">Unggah transaksi dari USB</a>
                            </li>
                        </ul>
                    </div>
                    <div class="btn-group">
