...
<?php
	$headcol = '<tr align="center" border="1">
                ...
                <th width="30">DPK</th>
                <th width="30">Pelaksanaan<br>Upacara</th>
	...
	foreach($querycok->result() as $que) {
        ...
        if (isset($que->date_shift2))
        {
            //echo $que->date_shift2." => ".$que->date_in2."<br>";
                ...
                {
                    $datarekap[$que->userid][$que->date_shift]='UPC';
                }
        }
    ...
    $tampilanReport .= '<tr align="center"><td colspan="14" align="left" ><h4> Unit Kerja: '.$nama_dept.'</h4></td></tr>';
	$tampilanReport .= $headcol;

    $jP = 0; $jA = 0; $OjFF = 0; $jL = 0; $jS = 0; $jC = 0; $jDL = 0; $jPDK = 0; $jTB = 0; $jIJ = 0; $jTD = 0; $jPC = 0;
    $jM=0;$jDPK=0;$jUpacara=0;
	...
	{				
		...
		for($i=0;$i<count($arr_days);$i++){		
			if(isset($datarekap[$dataatt->userid][$arr_days[$i]])) {
                ...
                else if ($datarekap[$dataatt->userid][$arr_days[$i]]==='UPC') $upacara++;
			}
