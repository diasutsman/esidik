...
<script>
    ...
    function doSinkronData() {
        ...
        var cMsg2=cMsg+'<form class="bootbox-form"><select class="bootbox-input bootbox-input-select form-control" id="pilsink"><option value="0">Sesuai kondisi saat ini...</option><option value="1">Hanya pegawai yang tidak ada di aplikasi</option></select></form>';

        bootbox.confirm(cMsg2, function (result) {
            if (result) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    type: 'POST',
                    data: {'id': cekData,'pil':$("#pilsink").val()},
                    success: function (data) {
                        bootbox.alert(data.msg);
                    }
                });
