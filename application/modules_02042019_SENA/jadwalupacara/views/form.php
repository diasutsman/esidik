...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="jam">Jam</label>
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="form-group form-inline" >
            <div class="input-daterange input-group" >
                <input type="text" class="input-sm form-control" name="jam" id="jam" value="<?php echo date("H:n")?>"/>
                <span class="input-group-addon">s/d</span>
                <input type="text" class="input-sm form-control" name="jam2" id="jam2" value="<?php echo date("H:n",time()+7200);?>" />
            </div>
        </div>
    </div>
</div>
