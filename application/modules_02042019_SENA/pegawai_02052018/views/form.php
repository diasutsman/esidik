        ...
        <div class="ibox-content">
            <div class="ibox float-e-margins ">
                <div class="ibox-content gray-bg">
                    <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group">
                                    <input class="form-control" placeholder="TMT"   readonly name="jftdate" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <?php echo form_dropdown("kedudukan",$this->utils->getKedudukanPegawai(),$field["kedudukan"],"id='kedudukan' class='form-control input-sm' disabled");?>
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <?php echo form_dropdown("eselon",$lstEselon,$field["eselon"],"id='eselon' class='form-control input-sm' disabled");?>
                            </div>
                            <div class="col-md-offset-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kelasjabatan">Kelas Jabatan</label>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <?php echo form_dropdown("kelasjabatan",$lstKelas,$field["kelasjabatan"],"id='kelasjabatan' class='form-control input-sm' disabled");?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
				<input type="text" class="input-sm form-control" name="cari_unker2" id="cari_unker2" value="<?php echo $field["plt_deptname"]?>" placeholder="Unit Kerja ..." disabled>
                                ...
                                <!-- <div class="input-group">
                                    <div class="unker2 input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button class="btn btn-white btn-sm hidden" type="button"><span class="caret"></span></button>
                                        </div>
                                    </div>
                                    <div class="input-group-btn">
                                        <button class="btn btn-default btn-sm hidden" type="button" id="clear2" title="Clear"><span class="fa fa-remove"></span></button>
                                    </div>
                                </div>
				...
				-->
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group date">
                                    <input class="form-control" placeholder="TMT" name="tmt_plt" value="<?php echo ymdTodmy($field["tmt_plt"])?>"  disabled type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <?php echo form_dropdown("plt_eselon",$lstEselon,$field["plt_eselon"],"id='plt_eselon' class='form-control input-sm' disabled");?>
                            </div>
                            <div class="col-md-offset-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="plt_kelasjabatan">Kelas Jabatan</label>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <?php echo form_dropdown("plt_kelasjabatan",$lstKelas,$field["plt_kelasjabatan"],"id='plt_kelasjabatan' class='form-control input-sm' disabled");?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <input id="plt_sk" name="plt_sk" type="text"  placeholder="SK PLT/PLH" disabled value="<?php echo $field["plt_sk"]?>" class="form-control col-md-12 col-xs-12">
                            </div>
                            <div class="col-md-offset-6">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="plt_kelasjabatan">Jabatan</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input id="plt_jbtn" name="plt_jbtn" type="text"  placeholder="Jabatan" disabled value="<?php echo $field["plt_jbtn"]?>" class="form-control col-md-12 col-xs-12">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <input class="form-control" placeholder="NPWP" name="npwp" value="<?php echo $field["npwp"]?>" type="text" disabled>
                            </div>
                            <div class="col-md-offset-6">
                                <?php
                                $cek1=""; $cek2="";
