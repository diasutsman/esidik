	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content">
			<div class="row form-horizontal">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-3 col-xs-12" for="jnsupcr">Presensi</label>
                    <div class="col-sm-3" id="data_6">
                        <select class="input-sm form-control" id="jnsupcr">
                            <option value="0">Reguler</option>
                            <option value="1">Upacara</option>
                            <option value="2">Reguler dan Upacara</option>
                        </select>
                    </div>
                </div>
...
$(function(){
	...
	$('#btnproses').click(function(){
		...
		$('<form action="<?php echo site_url('rpttransaksi/view');?>" method="POST" target="_blank" style="display:none">' +
            ...
            '<input type="hidden" name="lap" value="'+par12+'" />'+
