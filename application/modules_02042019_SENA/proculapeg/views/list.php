...
$url_pag =  site_url("proculapeg/pagging/0");
        ...
        <table class="table table-striped  table-bordered">
            ...
            foreach($result as $row)
            {
                ...
                <tr>
                    ...
                    <td><?php echo $row->abname.'<br>Tgl. '.ymdTodmy($row->tmulai).' s/d '.ymdTodmy($row->takhir).'<br>Note: '.$row->keterangan
                    ?>
                    </td>
                    <td><?php echo '<span class="label-info">'.$this->mdl_ulapeg->statusdata($row->status_persetujuan).'</span>'?>
                        <?php echo $row->status_persetujuan == null? "": "<br>Oleh: ".$row->approve_oleh;?>
                    </td>
                </tr>
                <?php
