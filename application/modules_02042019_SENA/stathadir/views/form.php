        ...
        <div class="ibox-content gray-bg">
            <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txt1">Kategori</label>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <?php echo form_dropdown("idkat",$this->utils->getKategoriPresensi(1),"","id='idkat' class='form-control input-sm'");?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txt6">Tidak Menghitung</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <label class="radio-inline"> <input checked value="0" id="txt6" name="ign_to" type="radio" > Jam Masuk & Keluar </label>
                        <label class="radio-inline"> <input value="1" id="txt7" name="ign_to" type="radio" > Jam Masuk </label>
                        <label class="radio-inline"> <input value="2" id="txt8" name="ign_to" type="radio"> Jam Keluar </label>
                    </div>
                </div>
