        ...
        if ($byuser == 1) {
            ...
            if ($empinfo['isplt'] == 1) {
                ...
                if ($empinfo['kriteriaPlt'] == 1 || $empinfo['kriteriaPlt'] == 2) {
                    ...
                    <tr style="border-bottom:2px solid">
                        <td width="150" style="border:0px" class="text"><b>Total Pengurangan s</b></td>
                        <td style="border:0px" class="text"><b>: Rp. </b></td>
                        <td width="150" style="border:0px" align="right" class="num">
                            <b><?php echo $showpdf == 1 ? number_format($pengurangan, 0, ',', '.') : $excelid == 1 ? ceil(round($pengurangan, 2)) : number_format($pengurangan, 0, ',', '.'); ?></b>
                        </td>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                    ...
                    foreach ($data as $row) {
                        ...
                        <tr>
                            ...
                            <td align="right"
                                class="num"><?php echo $showpdf == 1 ? number_format(ceil(round($row['total'], 2)), 0, ',', '.') : $excelid == 1 ? ceil(round($row['total'], 2)) : number_format(ceil(round($row['total'], 2)), 0, ',', '.'); ?></td>
                        
						<?php  
							$totals = number_format(ceil(round($row['total'], 2)), 0, ',', '.');
							$subtotal += $totals;
                    ...
                    <tr>
                        ...
                        <td align="center" class="num"><b><?php echo $footah['totalpersen'] ?></b></td>
                        <td align="right" class="num">
                            <b><?php echo $excelid == 1 ? number_format($pengurangan, 0, ',', '.'): number_format($pengurangan, 0, ',', '.'); ?></b>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <div style="margin-top: 75px">
        <table border="0" style="border: none; width: 100%">
            ...
            <tr>
                ...
                <td width="20%" class="ttd"></td>
                <td width="20%" class="ttd"></td>
                <td colspan="3" width="35%" class="text ttd" style="padding-bottom: 100px;">
                    <b><?php echo $ttd_jabatan; ?></b></td>
            </tr>
            <tr></tr>
            <tr></tr>
            <tr></tr>
