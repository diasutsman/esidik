		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				<div class="row">
					...
					<div class="col-sm-1 m-b-xs">
						<a id="btnDel" class="btn btn-sm btn-danger" href="#" onclick="doDel()"><i class="fa fa-minus"></i> Hapus</a>
					</div>
...
<script>
	...
	function doDel()
	{
		...
		var url ="<?php echo site_url('jadwalupacara/form2')?>";
		$("#input_data").html('<div style="position:absolute;left:0;right:0;top:50%;"><center></center></div>').load(url);
		//$("#btn_simpan").show();
		showPopup('#popup');
        <?php } ?>
