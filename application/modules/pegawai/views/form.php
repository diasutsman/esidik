            ...
            <div class="ibox float-e-margins ">
                <div class="ibox-content gray-bg">
                    <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group">
                                    <div class="input-group date">
                                        <input class="form-control" placeholder="TMT" readonly name="jftdate" value="<?php echo ymdTodmy($field["jftdate"])?>" type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
							<label class="control-label col-md-2 col-sm-2 col-xs-12" for="jenisjabatan"></label>
                            <div class="col-md-2 col-sm-2 col-xs-12">
								<?php 
									if($field["status_ps"] == 2){
										$ketps = 'Pembebasan Sementara';
									}else{
										$ketps = '';
									}
									
								?>
                                 <input class="form-control" placeholder="Nomor SK"  readonly name="stsps" value="<?php echo $ketps;?>"  type="text">
                            </div>
							<div class="col-md-2 col-sm-2 col-xs-12">
                                 <input class="form-control" placeholder="Nomor SK"  readonly name="nskps" value="<?php echo $field["nskjabat_ps"]?>"  type="text">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group ">
                                    <input class="form-control" placeholder="TMT"  readonly name="tmtps" value="<?php echo ymdTodmy($field["tskjabat_ps"])?>"  type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="input-group">
                                     <div class="input-group date">
                                        <input class="form-control" placeholder="TMT" readonly name="tmtkedudukan" value="<?php echo ymdTodmy($field["tmtkedudukan"])?>" type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <?php echo form_dropdown("eselon",$lstEselon,$field["eselon"],"id='eselon' ".($field["eselon"] != "" ? "disabled" : "")." class='form-control input-sm' ");?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <div class="input-group">
                                    <input class="form-control" placeholder="No. Rekening" <?php echo $field["no_rekening"] != "" ? "readonly" : "" ?> name="no_rekening" id="no_rekening" value="<?php echo $field["no_rekening"]?>" type="text">
                                    <span class="help-inline text-danger" id="errmsg-no_rekening"></span>
								
                                <div class="input-group-btn">
								<?php if ($field["no_rekening"] == "") { ?>
