...
class Pegawai_model extends CI_Model {
    ...
    public function getDaftar($dipaging=0,$limit=10,$offset=1,$id=null,$cari=null,$count=0,$sOrder=null)
    {
    ...
    public function getJumlahJabodetabek($cari=null)
    {
        $sql =  "SELECT DISTINCT(a.userid) as total
        FROM rosterdetailsatt AS a
        LEFT JOIN userinfo AS b ON a.userid = b.userid
        LEFT JOIN departments AS c ON b.deptid = c.deptid
        WHERE (1=1) AND c.wilayah = '1' ";
	...
	public function getJumlahPegawai($cari=null)
    {
        $sql =  "SELECT COUNT(*) AS total FROM userinfo AS a 
		LEFT JOIN departments AS b ON a.deptid = b.deptid
        WHERE (1=1) AND b.wilayah = '1' ";
    ...
    public function getJumlahShift($cari=null)
    {
        $sql =  "SELECT DISTINCT(a.userid) as total
        FROM rosterdetails AS a
        LEFT JOIN userinfo AS b ON a.userid = b.userid
        LEFT JOIN departments AS c ON b.deptid = c.deptid
        WHERE (1=1) AND c.wilayah = '1' ";
        if($cari!='' && $cari !=null) $sql .= " $cari ";
    ...
    public function getJadwalkerja($cari=null)
    {
        $sql =  "SELECT DISTINCT(a.userid) AS userid
        FROM rosterdetails AS a
        LEFT JOIN userinfo AS b ON a.userid = b.userid
        LEFT JOIN departments AS c ON b.deptid = c.deptid
        WHERE (1=1) AND c.wilayah = '1' ";
    ...
    public function cekStatusWFH($cari=null)
    {

        $sql =  "SELECT DISTINCT(a.userid) AS userid, a.attendance
        FROM rosterdetailsatt AS a
        LEFT JOIN userinfo AS b ON a.userid = b.userid
        LEFT JOIN departments AS c ON b.deptid = c.deptid
        WHERE (1=1) AND c.wilayah = '1' AND (a.attendance = 'WFH')  ";
        if($cari!='' && $cari !=null) $sql .= " $cari ";
        return $this->db->query($sql);

    }

    public function cekStatusDINAS($cari=null)
    {
        ...
        LEFT JOIN userinfo AS b ON a.userid = b.userid
        LEFT JOIN departments AS c ON b.deptid = c.deptid
        WHERE (1=1) AND c.wilayah = '1' AND (a.attendance = 'AB_13') ";
        if($cari!='' && $cari !=null) $sql .= " $cari ";
        return $this->db->query($sql);
    ...
    public function cekStatusWFH2($cari=null)
    {
    ...
    public function cekStatusWFH3($cari=null)
    {

        $sql =  "SELECT DISTINCT(a.userid) AS userid, a.attendance FROM rosterdetailsatt AS a 
        LEFT JOIN userinfo AS b ON a.userid = b.userid 
        LEFT JOIN departments AS c ON b.deptid = c.deptid 
        WHERE (1=1) AND c.wilayah = '1'  ";
        if($cari!='' && $cari !=null) $sql .= " $cari ";
    ...
    public function cekStatusWFH4($cari=null)
    {

        $sql =  "SELECT DISTINCT(a.userid) AS userid, a.absence FROM rosterdetails AS a 
        LEFT JOIN userinfo AS b ON a.userid = b.userid 
        LEFT JOIN departments AS c ON b.deptid = c.deptid 
        WHERE (1=1) AND c.wilayah = '1' AND (a.absence = 'CVD1' or a.absence = 'CVD2')  ";
        if($cari!='' && $cari !=null) $sql .= " $cari ";
    ...
    public function cekStatusWFH5($cari=null)
    {
        ...
        LEFT JOIN userinfo AS b ON a.userid = b.userid
        LEFT JOIN departments AS c ON b.deptid = c.deptid
        WHERE (1=1) AND c.wilayah = '1' AND (a.attendance = 'WFH' OR a.attendance = 'AB_13') ";
        if($cari!='' && $cari !=null) $sql .= " $cari ";
        return $this->db->query($sql);
    ...
    public function dapetiniduser($areaid)
    {
        ...
        $kared= explode(',', $this->session->userdata('s_area'));

        $this->db->where_in('areaid', $kared);

        /*$this->db->group_start();
        $ids_chunk = array_chunk($kared,25);
    ...
    public function getsnareaaktif($areaid) {
        $this->db->select('sn,delay,lastactivity');
        $this->db->from('iclock');
        $this->db->where('areaid', $areaid);
        $this->db->having('TIMESTAMPDIFF(SECOND,lastactivity,NOW()) < (delay+900)',null, false);
        return $this->db->get();
    }
    ...
    public function get_fp($userid) {
        ...
        $this->db->from('template');
        //$this->db->group_by('group by userid, fingerid, valid');
        $this->db->where('userid', $userid);
        return $this->db->get();
    }
    ...
    public function get_panrb($cari=null)
    {
        $sql =  "SELECT * FROM riw_panrb WHERE (1=1)  ";
        if($cari!='' && $cari !=null) $sql .= " $cari ";
        return $this->db->query($sql);
