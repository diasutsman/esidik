...
?>
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <th rowspan="2" align="center">Pelaksanaan<br>Upacara</th>
            <th colspan="3" align="center">Kehadiran</th>
            ...
            <th colspan="2" align="center">Pelaksanaan<br>Upacara</th>
        </tr>
        <tr>
            <th align="center">Hari<br/>Kerja</th>
            <th align="center">WFH</th>
        ...
        foreach ($data as $row) {
            ...
            <tr border="1">
                ...
                <td align="center"><?php echo $row["totalUpacara"]?></td>
                <td align="center"><?php echo $row["attendance"]?></td>
                <td align="center"><?php echo $row["wfh"]?></td>
                ...
                <?php } ?>
                <td align="center"><?php echo $row["totalkehadiran"]?></td>
                ...
                <td align="center"><?php echo $row["jmlUpacaraYa"]?></td>
                <td align="center"><?php echo $row["totalUpacara"]-$row["jmlUpacaraYa"]?></td>
            </tr>
        <?php }
