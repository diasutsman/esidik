    ...
    <div class="popup-wrapper" id="popup5">
        <div class="popup-container">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="reguler">Jenis Mesin </label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <select class="form-control" name="reguler" id="reguler">
                                <option value="1" >Reguler</option>
                                <option value="0" >Upacara</option>
                            </select>
                        </div>
                    </div>
                </div>
    ...
    <div class="popup-wrapper" id="popup7">
        <div class="popup-container">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="isreguler">Jenis Mesin </label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <select class="form-control" name="reguler" id="isreguler">
                                <option value="1" >Reguler</option>
                                <option value="0" >Upacara</option>
                            </select>
                        </div>
        ...
        if (cek == 1) {
            ...
            $.getJSON('<?php echo site_url('setdev/edit')?>/'+cek_del,function() {})
                .done(function(response) {
                    ...
                    $("#isreguler").val(response['is_reguler']);
                });
