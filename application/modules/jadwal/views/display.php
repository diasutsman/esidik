	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content">
			...
			<div class="row form-horizontal">
				...
				<div class="form-group">
					<label class="control-label col-md-2 col-sm-3 col-xs-12" for="stspeg">Pilih File Excel</label>
					<div class="col-sm-7">
					<?php
                        echo form_open_multipart('jadwal/doimport');
                    ?>
                        <div class="row form-horizontal">
...
<script>
	$(function(){
		...
		$('#btncari').click(function(){
			load_url('<?php echo site_url('jadwal/pagging/0') ?>', '<?php echo (isset($order)?$order:'id')?>','<?php echo (isset($typeorder)?$typeorder:'sorting')?>');
		});
	...
	function saveForm() {
		if (($("#txt1").val() != "")) {
			$.ajax({
				url: '<?php echo site_url('jadwal/save');?>', dataType: 'json', type: 'POST', data: $("#inputForm").serialize(), success: function (data) {
					bootbox.alert(data.msg);
				}
			});
		} else {
