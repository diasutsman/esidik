...
class Jadwalkrjupacara_model extends CI_Model {
    ...
    {
        $sql = "select a.userid, a.rosterdate, a.rostertime,a.rostertime_end,a.attendance,a.attendance_lainnya, a.editby from rosterdetailsatt_upacara a 
    ...
    {
        $this->db->select('a.userid, a.rosterdate,a.rostertime,a.rostertime_end, a.attendance,a.attendance_lainnya, a.editby, c.name, a.notes,a.update_date');
