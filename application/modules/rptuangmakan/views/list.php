 ...
 */
$url_pag =  "'".site_url("rptuangmakan/pagging/0")."'";
    ...
    <div class="dataTables_wrapper dt-bootstrap">
        <table class="table table-striped  table-bordered">
            ...
            <tr>
                ...
                <th>Nama</th>
                <th>Golongan</th>
                <th>Kehadiran Hari Kerja</th>
                <th>Tarif Uang Makan</th>
                <th>Jumlah Kotor</th>
                <th>PPh</th>
			...
			foreach($result as $row)
            {
                ...
                <tr>
                    ...
                    <td><?php echo $row["golru"]?></td>
                    <td style="text-align: center"><?php echo format_angka($row["hadir"])?></td>
					
                    <td style="text-align: right"><?php echo format_angka($row["tarif"])?></td>
                    <td style="text-align: right"><?php echo format_angka($row["kotor"])?></td>
                    <td style="text-align: right"><?php echo format_angka($row["pajak"])?></td>
                    <td style="text-align: right"><?php echo format_angka($row["bersih"])?></td>
                </tr>
                <?php
...
<script>
    ...
    function load_url(theurl,div)
    {
        ...
        $.ajax({
            method:"post",
            url: theurl,
            data:{"lmt":par4,"cari":par5,"org":par6,"stspeg":par7,"jnspeg":par9,"start":par8,"end":par11},
