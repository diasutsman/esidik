...
class Ajax extends CI_Controller {
    ...
    function getUnitKerja()
    {
     ...
     function getUnitKerjaJabodetabek()
    {
        $this->load->view('unkerja_jabodetabek');
    }
    ...
    function child_unkerja_jabodetabek($param=1,$lvl=1)
    {
        $data['param'] = $param;
        $data['lvl'] = $lvl;
        $this->load->view('next_unkerja_jabodetabek',$data);
    }
