...
<script>
	$(function(){
		...
		$('#btncaridata').click(function(){
			load_url('<?php echo site_url('procupacara/pagging/0') ?>', '<?php echo (isset($order)?$order:'id')?>','<?php echo (isset($typeorder)?$typeorder:'sorting')?>');
		});
        ...
        $('#btnproses').click(function(){
            ...
            if(cek > 0)
            {
                ...
                $.ajax({
                    dataType: 'json',
                    type    : 'POST',
                    url: '<?php echo site_url('procupacara/pegawai') ?>',
            ...
            bootbox.confirm("Anda yakin memproses semua data (berdasarkan unit kerja)?", function(result) {
                if(result) {
                    ...
                    $.ajax({
                        dataType: 'json',
                        type    : 'POST',
                        url: '<?php echo site_url('procupacara/allpegawai') ?>',
