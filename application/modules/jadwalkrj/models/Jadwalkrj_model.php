...
class Jadwalkrj_model extends CI_Model {
    ...
    {
        $this->db->select('a.userid, a.rosterdate, a.absence, d.attendance, d.editby, b.abname, b.abid, c.name, d.notes');
    ...
    {
        $this->db->select('a.userid, a.rosterdate, a.absence, d.attendance, d.editby, b.atname, c.name, a.notes, b.atid ');
        $this->db->from('rosterdetails a');
        $this->db->join('userinfo c', 'a.userid=c.userid');
        $this->db->join('rosterdetailsatt d', 'a.userid=d.userid and a.rosterdate=d.rosterdate');
    ...
    public function gettranslog($userid, $tgl)
    {
        ...
        $this->db->join('iclock b','b.sn=a.sn');
        $this->db->join('userinfo c', 'a.userid=c.userid');
        $this->db->where('a.userid', $userid);
