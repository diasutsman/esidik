...
class Pegawai extends MX_Controller {
    ...
    public function sinkrondata()
    {
        ...
        $lstdata = getContentUrl("https://ropeg.setjen.kemendagri.go.id/restserver/index.php/api/for_absen/pegawai_dengan_plt_plh");
		//$lstdata = getContentUrl($lstdata);
        if ($lstdata) {
