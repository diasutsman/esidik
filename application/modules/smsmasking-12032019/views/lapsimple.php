...
<center>
<h1>
    <?php echo strtoupper('Daftar Pegawai'); ?>
</h1>
...
<table width="100%" border="1" class="tblnoborder" cellspacing="0" cellpadding="0">
    ...
    ?>
    <tr>
		<td align="center" class="text"><?php echo $no?></td>
        <td align="left" class="text"><?php echo $que->userid?></td>
        <td align="left" class="text"><?php echo $que->name?></td>
        <td align="left" class="text"><?php echo $nip."<br>".$nama;?></td>
        <td align="center" class="num"><?php echo $value?></td>
	</tr>
    <?php 
        $no++;
        }
