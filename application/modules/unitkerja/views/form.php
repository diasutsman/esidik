            ...
            <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        ...
                        <p class="help-block">Sesuaikan dengan Kode UNOR Di SIMPEG</p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="wilayah">Wilayah</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="input-sm form-control" id="wilayah" name="wilayah">
