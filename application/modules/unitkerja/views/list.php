...
<div class="table-responsive">
    ...
    <table class="table table-striped  table-bordered">
        ...
        <tr>
            ...
            <th  onClick="load_url('<?php echo $url_pag?>','b.deptname','<?php echo (isset($order)?(($order=='b.deptname')?$sorting:'sorting'):'sorting_asc')?>')"><div class="<?php echo (isset($order)?(($order=='b.deptname')?$typeorder:'sorting'):'sorting_asc')?>">Wilayah</div></th>
            <th></th>
        </tr>
        </thead>
        <tbody>
