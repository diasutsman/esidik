...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    foreach ($empinfo as $row) {
        ...
        $totalan1 = $totalan1 + $tunjangan1;
        $totalan2 = $totalan2 + $tunjangan2;
        $totalan3 = $totalan3 + $tunjangan3;
