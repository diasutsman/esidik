                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="input-sm form-control" id="jnslap">
                                        ...
                                        <?php } ?>
                                        <option value="4">Selisih Tunjangan</option>
                                        <option value="5">Selisih Tunjangan PLT/PLH</option>
                                    </select>
                                </div>
                            </div>
                            <!--<div class="form-group">
                    ...
                    <div id="tab-3" class="tab-pane" style="padding-top: 10px">
                        ...
                        <div class="row form-horizontal">
                            ...
                            <div class="form-group" style="padding-left: 30px;padding-bottom: 20px">
                                <span class="alert alert-info"><strong>PERHATIAN!!!</strong> Untuk Export: dasar pilihan Unit Kerja dari Tab Form</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" >
                                    <button type="submit" id="btnimpt" class="btn btn-sm btn-success" name="btn"><i class="fa fa-file-excel-o"></i>  Submit File!</button>
                                    <button type="button" id="btnexpt" class="btn btn-sm btn-success"><i class="fa fa-file-excel-o"></i>  Export to Excel!</button>
                                </div>
                            </div>
                        </div>
                        <?php
...
$(function(){
    ...
    $('#btnexpt').click(function(){
        ...
        $('<form action="<?php echo site_url('rpttunjangan/expimportxls');?>" method="POST" target="_blank" style="display:none">' +
            '<input type="hidden" name="org" value="'+par6+'" />'+
            '<input type="hidden" name="stspeg" value="'+par7+'" />'+
            '<input type="hidden" name="jnspeg" value="'+par9+'" />'+
            '<input type="hidden" name="xls" value="1" />'+
