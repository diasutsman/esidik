...
<hr /><?php } ?>
<h1><center>
    <?php echo "LAPORAN SELISIH TUNJANGAN KINERJA"; ?>
</center></h1><br>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tbody>
  <?php 
	$x=1; $totaltun=0; $totaltunbaru=0; $tottotaltun=0; $tottotaltunbaru=0; $totalan = 0;
  ...
  <tr class="<?php if($x % 2 === 0) echo 'even'; else echo 'odd'; ?>">
    ...
    <td align="right"><?php echo number_format(ceil(round($row['tunjanganbaru'],2)),0,',','.'); ?></td>
    <td align="right"><?php echo number_format(ceil(round($row['totaltunjangan'],2)),0,',','.'); ?></td>
    <td align="right"><?php echo number_format(ceil(round($row['totaltunjanganbaru'],2)),0,',','.'); ?></td>
    <td align="right"><?php echo number_format(ceil(round($row['tunjangan'],2)) - ceil(round($row['totaltunjangan'],2)),0,',','.'); ?></td>
    <td align="right"><?php echo number_format(ceil(round($row['tunjanganbaru'],2)) - ceil(round($row['totaltunjanganbaru'],2)),0,',','.'); ?></td>
    <td align="right"><?php echo number_format((ceil(round($row['tunjanganbaru'],2)) - ceil(round($row['totaltunjanganbaru'],2))) - (ceil(round($row['tunjangan'],2)) - ceil(round($row['totaltunjangan'],2))),0,',','.'); ?></td>
  </tr>
 <?php 
  ...
  <tr>
    ...
    <td align="right"><b><?php echo number_format($totaltunbaru,0,',','.'); ?></b></td>
    <td align="right"><b><?php echo number_format($tottotaltun,0,',','.'); ?></b></td>
    <td align="right"><b><?php echo number_format($tottotaltunbaru,0,',','.'); ?></b></td>
    <td align="right"><b><?php echo number_format($totaltun - $tottotaltun,0,',','.'); ?></b></td>
    <td align="right"><b><?php echo number_format($totaltunbaru - $tottotaltunbaru,0,',','.'); ?></b></td>
    <td align="right"><b><?php echo number_format(($totaltunbaru - $tottotaltunbaru) - ($totaltun - $tottotaltun),0,',','.'); ?></b></td>
  </tr>
</table>
<br><br>
