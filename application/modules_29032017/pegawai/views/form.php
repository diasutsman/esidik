            ...
            <div class="ibox float-e-margins ">
                <div class="ibox-content gray-bg">
                    <form class="form-horizontal form-label-left" name="inputForm" id="inputForm" method="post">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="plt_eselon">Eselon</label>
                            <div class="col-md-4 col-sm-3 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-12">
                                <input class="form-control" placeholder="No. Rekening" name="no_rekening" value="<?php echo $field["no_rekening"]?>" type="text">
                            </div>
                            <div class="col-md-offset-6">
