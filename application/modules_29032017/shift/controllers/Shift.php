...
class Shift extends MX_Controller {
	...
	function index_list()
	{
        ...
        $uri_segment=3;
        $offset = 0;
        $query = $this->shift->getDaftar(1,10,$offset,null,null);
        $jum_data = $this->shift->getDaftar(0,null,null,null,null);
        $this_url = site_url('shift/pagging/');
    ...
    public function pagging($page=0)
    {
        ...
        $query = $this->shift->getDaftar(1,$limited,$offset,null,$SQLcari);
        $jum_data = $this->shift->getDaftar(0,null,null,null,$SQLcari);
        $this_url = site_url("shift/pagging");
    ...
    {
        echo json_encode($this->db->get_where('master_shift', array('id_shift' => $noId))->row_array());
    }
