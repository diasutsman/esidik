    ...
    <div class="col-lg-12">
        <div class="tabs-container">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#tab-1"><span class="label label-warning">Transaksi Log</span></a></li>
                <li class=""><a data-toggle="tab" href="#tab-2"><span class="label label-info">Daftar shif</span></a></a></li>
            </ul>
