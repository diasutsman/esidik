...
class Unitkerja extends MX_Controller {
    ...
    public function save()
    {
        ...
        if ($idx==0)
        {
            ...
            if (!$insert) {
                createLog("Menambah organisasi ".$t1." ".$t2 ." ".$t3,"Sukses");
                $data['msg'] = 'Maaf, Tidak bisa menyimpan data..';
                $data['status'] = 'error';

            } else {
                createLog("Menambah organisasi ".$t1." ".$t2 ." ".$t3,"Gagal");
        ...
        else
        {
            ...
            $data=$this->db->get("departments")->row_array();
            log_history("edit","departments",$data);
            ...
            if(!$update){
                createLog("Merubah organisasi ".$t1." ".$t2 ." ".$t3,"Gagal");
                $data['msg'] = 'Maaf, Tidak bisa merubah data..';
                $data['status'] = 'error';

            }else{
                createLog("Merubah organisasi ".$t1." ".$t2 ." ".$t3,"Sukses");
    ...
    public function hapus()
    {
        ...
        for($i=0;$i<count($id);$i++){
            ...
            if (isset($datas)) {
                createLog("Menghapus organisasi " . $datas["deptid"] . " " . $datas["deptname"] . " " . $datas["parentid"], "Sukses");
            }
        }
