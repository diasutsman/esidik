...
<audio id="notif_message">
    <source src="<?php echo base_url('assets/sounds/all-eyes-on-me.ogg'); ?>" type="audio/ogg">
    <source src="<?php echo base_url('assets/sounds/all-eyes-on-me.mp3'); ?>" type="audio/mpeg">
</audio>
<div id="wrapper">
    <div id="page-wrapper" class="green-bg">
        <div class="row blue-bg header-back"></div>
        <div class="row border-bottom white-bg">
            <nav class="navbar navbar-static-top" role="navigation">
                <div class="navbar-header">
                    ...
                    <a href="<?php echo site_url("secdata") ?>"
                       class="navbar-brand"><?php echo $this->config->item('app_name') ?></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo site_url("repost")?>">Posting Ulang</a></li>
                                <li><a href="<?php echo site_url("regen")?>">Generate Absensi</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a aria-expanded="false" role="button" href="#" class="dropdown-toggle"
                               data-toggle="dropdown"><?php echo $this->session->userdata('s_username') ?> <b
                                        class="caret"></b></a>
        ...
        <div class="row wrapper border-bottom white-bg" style="padding: 0 5px 5px 5px;">
            ...
            <div class="col-md-3">
                <span class="pull-right" ><?php echo indo_date(date("Y-m-d")) ?>
                    <span id="txtjam" class="txtjam"><?php echo date("H:i:s") ?></span>
                </span>
            </div>
        </div>
...
<div id="loads" class="modal-backdrop" style="display:none;opacity:0.8 !important;background-color: #7f8d8e;">
    <div style="padding-top:15%;">
        <center><img src="<?= base_url() ?>assets/img/loading.gif" width="200px"></center>
    </div>
</div>
