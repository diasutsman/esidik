			...
			<div class="ibox-content">
				...
				<div class="row">
					...
					<div class="col-sm-3 m-b-xs">
						...
						{
							$options[$option['tahun']] = $option['tahun'];
						}

						if(isset($pilthn) && trim($pilthn) != '')
							$selected = $pilthn;

						$js = 'id="tahun" class="form-control input-sm" onChange="load_url('.$url_pag.','.$domId.');" name="tahun" size="1" ';
						echo form_dropdown('tahun',$options,$selected,$js);
						?>
					</div>
					<div class="col-sm-3">
