...
<div class="table-responsive">
    ...
    <table class="table table-striped  table-bordered">
        ...
        <tr>
            ...
            <th  onClick="load_url('<?php echo $url_pag?>','terminal_id','<?php echo (isset($order)?(($order=='terminal_id')?$sorting:'sorting'):'sorting_asc')?>')"><div class="<?php echo (isset($order)?(($order=='terminal_id')?$typeorder:'sorting'):'sorting_asc')?>">ID Terminal</div></th>
            ...
            <th  onClick="load_url('<?php echo $url_pag?>','status','<?php echo (isset($order)?(($order=='status')?$sorting:'sorting'):'sorting_asc')?>')"><div class="<?php echo (isset($order)?(($order=='statusd')?$typeorder:'sorting'):'sorting_asc')?>">Status</div></th>
