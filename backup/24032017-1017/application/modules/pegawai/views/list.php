    ...
    <div class="dataTables_wrapper dt-bootstrap">
        <table class="table table-striped table-bordered small">
            ...
            <tr>
                ...
                <th onClick="load_url('<?php echo $url_pag?>','userid','<?php echo (isset($order)?(($order=='userid')?$sorting:'sorting'):'sorting')?>')"><div class="<?php echo (isset($order)?(($order=='userid')?$typeorder:'sorting'):'sorting')?>">ID</div></th>
                ...
                <th onClick="load_url('<?php echo $url_pag?>','privilege','<?php echo (isset($order)?(($order=='privilege')?$sorting:'sorting'):'sorting')?>')"><div class="<?php echo (isset($order)?(($order=='privilege')?$typeorder:'sorting'):'sorting')?>">Level</div></th>
            ...
            foreach($result as $row)
            {
                ...
                <tr id="rowdata-<?php echo $row->id?>">
                    ...
                    <td><a class="btn btn-xs btn-warning" href="<?php echo site_url("pegawai/form/".$row->id)?>"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php
...
<script>
    ...
    function load_url(theurl,orderby,sortingby)
    {
        ...
        $.ajax({
            method:"post",
            url: theurl,
            data:{"lmt":par4,"cari":par5,"org":par6,"stspeg":par7,'order':orderby,'sorting':sortingby},
