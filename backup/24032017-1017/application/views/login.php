                ...
                <div class="ibox-content" style="color:#000">
                    ...
                    <form class="m-t" role="form" action="login" method="post">
                        ...
                        <div class="input-group m-b">
                            ...
                            </span> <input class="form-control" type="text" required="" name="capture"><span class="input-group-addon"><a href="javascript:void()" id="refresh"><i class="fa fa-repeat"></i></a></span>
                        </div>
