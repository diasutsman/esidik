...
<html lang="en">
	...
	<div id="wrapper">
		<div id="page-wrapper" class="green-bg">
						...
						<ul class="nav navbar-top-links navbar-right">
							<li class="dropdown">
								<a class="dropdown-toggle count-info" data-toggle="dropdown" href="#" aria-expanded="false">
									...
									<span class="label label-danger"><?php echo jmlPesanBlmBaca() ?></span>
								</a>
			...
			<div class="row wrapper border-bottom white-bg" style="padding: 0 5px 5px 5px;">
				...
				<span class="col-md-1"> <span><i class="fa fa-clock-o" id="myJam" data-toggle="tooltip" data-placement="top" title="<?php echo indo_date(date("Y-m-d"))?>"></i> <span id="txtjam" class="txtjam"></span></span>
				</div>
	...
	<script>
		...
		function clock() {
			...
			document.querySelectorAll('.txtjam')[0].innerHTML = harold(hours) + ":" + harold(minutes) + ":" + harold(seconds);
